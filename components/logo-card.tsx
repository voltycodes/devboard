...
export default function LogoCard({text, logo}: LogoCardProps) {
  return (
    <div className="p-4 relative border-foreground/30 border-2 rounded-lg w-full aspect-square max-w-40 flex flex-col items-center justify-center">
      {logo === 'lc' ? (
        <svg className='absolute opacity-20 h-1/2 w-1/2 blur-sm' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 32 32">
        ...
        <svg className='absolute opacity-20 h-1/2 w-1/2 blur-sm' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
